...
class Database:
    ...
    def get_table_by_table_names(self, name):
    ...
    def create_table(self, table_string):
        ...
        for line in lines:
            if 'TABLE' in line:
                ...
                altName = self.thesaurus_object.get_synonyms_of_a_word(table_name)
                table.set_alternateName(altName)
    ...
    def alter_table(self, alter_string):
        ...
        for line in lines:
            if 'CONSTRAINT' in line:
                ...
                column_names = re.findall("ADD \(`(\w+)`\)", line)
